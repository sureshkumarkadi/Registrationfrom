...
tf = 'test_TestcaseNo100022'

#Test case No : 100022
class TestcaseNo100022(unittest.TestCase):
    def test_TestcaseNo100022(self) :
        try:
            ...
            password.send_keys(registrationform_testdata['password_8characterlimit'])
            ...
            if validationmessage_lastname.is_displayed():
                ...
                self.fail("Test case No : 100022 is failed")
