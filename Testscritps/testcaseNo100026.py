...
tf = 'test_TestcaseNo100026'

#Test case No : 100026
class TestcaseNo100026(unittest.TestCase):
    def test_TestcaseNo100026(self) :
        try:
            ...
            confirmpassword.send_keys(registrationform_testdata['confirmpassword_8characterlimit'])
            ...
            if validationmessage_lastname.is_displayed():
                ...
                self.fail("Test case No : 100026 is failed")
