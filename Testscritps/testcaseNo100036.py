...
tf = 'test_TestcaseNo100036'

#Test case No : 100036
class TestcaseNo100036(unittest.TestCase):
    def test_TestcaseNo100036(self) :
        try:
            ...
            validationmessage_contactno = browser.find_element_by_xpath(registrationform_locator['success_tickmark'])
            if validationmessage_contactno.is_displayed():
                print('pass')
            else:
                self.fail("Test case No : 100036 is failed")
