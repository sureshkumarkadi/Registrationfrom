...
tf = 'test_TestcaseNo100040'

#Test case No : 100040
class TestcaseNo100040(unittest.TestCase):
    def test_TestcaseNo100040(self) :
        try:
            ...
            dropdownselect.select_by_visible_text(registrationform_testdata['department_support'])

        except Exception:
            traceback.print_exc()
            browser.save_screenshot(folder_path+'\Screenshots\Testcase-%s.png' %tf)
            self.fail("Test case No : 100040 is failed")
        finally:
